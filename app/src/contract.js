/*
 this is just a copy from ../setup/tmp/contract.json
 Needs to be updated whenever that file changes.
 Once the contract code is final, that's nomore an issue, but during dev, it would be more convenient to directly access it.
*/
